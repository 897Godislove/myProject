...
?>
	...
	while ($datarows = mysqli_fetch_assoc($result)) {
		...
		$existingnickname = $datarows['nickname'];
	...
	if (isset($_POST['submit'])) {
		...
		if (!$result) {
			...
			header("location:extmyprofile.php");
		}
		// Updating my database
									...
									<div class="col-lg-6">
										<div class="central-meta">
											<div class="editing-info">
												...
												<form action="extmyprofile.php" method="post" enctype="multipart/form-data">
													<div class="form-group half">
														<input type="text" id="input" name="nickname" value="<?php echo $existingnickname ?>" required />
														<label class="control-label text-primary" for="input">Nickname</label><i class="mtrl-select"></i>
													</div>
													<div class="form-group half">
														<input type="text" name="name" value="<?php echo $existingname ?>" required />
														<label class="control-label text-primary" for="input">Full Name</label><i class="mtrl-select"></i>
													</div>
													<div class="form-group">
														<input type="text" required="required" name="email" value="<?php echo $existingemail ?>" />
														<label class="control-label" for="input">[email protected]</label></label><i class="mtrl-select"></i>
													</div>
													<div class="form-group">
														<input type="text" name="headline" />
														<label class="control-label" for="input">Headline</label><i class="mtrl-select"></i>
													</div>
													...
													<div class="form-group">
														<label class="text-primary fieldinfo" for="input">Select A New Profile Picture<br></label>
														<input type="file" accept="image/*" class="form-control" name="image" />
													</div>
													<div class="form-group">
														<textarea rows="4" id="textarea" name="bio"></textarea>
