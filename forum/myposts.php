    ...
    <body>
        ...
        <header class="bg-dark py-3 my-5 text-center" style="color: white;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class=""><i class="fas fa-cog" style="color:#27aae1"></i> My Posts</h3>
                    </div>
                    <div class="row mt-4">
        ...
        <!-- Main Area -->
        <section class="container-fluid py-2 mb-4" style="min-height: 400px;">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editpost.php?id=<?php echo $id; ?>"><span class="btn btn-success mt-sm-2">Edit</span></a>
                                        <a href="deletepost.php?id=<?php echo $id; ?>"><span class="btn btn-danger mt-sm-2">Delete</span></a>
                                    </td>
                                    <td><a href="fullpost.php?id=<?php echo $id; ?>" target="_blank"><span class="btn btn-primary mt-sm-2">Live Preview</span></a></td>
                                </tr>
                            </tbody>
                        <?php
                        }
