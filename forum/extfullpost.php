													...
													<div class="user-post">
														<div class="friend-info">
															...
															<div class="friend-name">
																<ins><a href="profile.php?email=<?php echo htmlentities($postemail); ?>"><?php echo $author; ?></a></ins>
																<span>published: <?php echo $datetime; ?></span>
																<span><?php echo "<h3>$category</h3>" ?></span>
																<div class="more">
															...
															<li class="post-comment">
																...
																<div class="post-comt-box">
																	<form method="post" action="fullpost.php?id=<?php echo $searchqueryparameter; ?>">
																		<textarea name="commenterthoughts" placeholder="Post your comment"></textarea>
																		<div class="add-smiles">
																		...
																		<button type="submit" name="commentsubmit"></button>
																	</form>
																</div>
															</li>
														</ul>
